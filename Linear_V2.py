...
# Este código toma medidas de regularización y preprocesamiento de datos
# para mejorar el desempeño de Linear_V1
...
from sklearn.utils import shuffle # Aleatorizar dataset
...
plt.savefig('matriz_m2_train.png')  # Guardar la imagen con el nombre especificado
...
plt.savefig('matriz_m2_valid.png')  # Guardar la imagen con el nombre especificado
plt.close()  # Cerrar la figura para liberar memoria
...
plt.savefig('matriz_m2_test.png')  # Guardar la imagen con el nombre especificado
plt.close()  # Cerrar la figura para liberar memoria
